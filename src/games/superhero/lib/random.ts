...
export function getRecentHistory(slug: string = "guess-superhero"): (string | number)[] {
...
export function addRecentHistory(slug: string = "guess-superhero", id: string | number, maxHistory: number = 30) {
  if (typeof localStorage === "undefined") return;
  try {
...
export function pickRandomEntity(pool: EntityItem[], slug: string = "guess-superhero", run: number = 0, isDaily: boolean = false): EntityItem {
