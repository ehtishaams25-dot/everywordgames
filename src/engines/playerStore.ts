...
export const achievements = [
  ...
  { id: "multi-board", name: "Board Splitter", description: "Play a multi-board Wordle mode.", test: (s: PlayerStats) => ["double-wordle", "triple-wordle", "quad-wordle", "hex-wordle", "octo-wordle", "sedecordle"].some((slug) => s.gameCounts[slug] > 0) },
  { id: "classic-five", name: "Classic Solver", description: "Play 5 Letter Wordle.", test: (s: PlayerStats) => s.gameCounts["5-letter-wordle"] > 0 },
